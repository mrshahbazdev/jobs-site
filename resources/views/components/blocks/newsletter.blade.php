        ...
        <div class="rounded-3xl bg-primary p-8 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center gap-6">
                ...
                <form action="{{ route('subscribe') }}" method="POST" class="flex w-full max-w-md flex-col gap-3 sm:flex-row">
                    @csrf
                    <input name="email_or_phone" required class="flex-1 rounded-xl border-0 px-4 py-4 text-slate-900 placeholder:text-slate-600 focus:ring-2 focus:ring-white" placeholder="Email or WhatsApp number" type="text"/>
                ...
                <a href="https://chat.whatsapp.com/your-group-link" class="flex items-center gap-3 rounded-xl bg-[#25D366] px-8 py-4 font-black text-[#0f592a] hover:bg-[#25D366]/90 transition-colors shadow-lg">
