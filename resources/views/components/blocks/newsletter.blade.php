    ...
    <div class="mx-auto max-w-7xl">
        <div class="rounded-3xl bg-primary p-8 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center gap-6">
                ...
                <a href="{{ $settings['whatsapp_group_link'] }}" target="_blank" rel="noopener" class="flex items-center gap-3 rounded-xl bg-[#075E54] px-8 py-4 font-black text-white hover:bg-[#064e46] transition-colors shadow-lg">
