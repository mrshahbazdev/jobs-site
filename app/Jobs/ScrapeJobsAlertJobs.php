...
class ScrapeJobsAlertJobs implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Artisan::call('scrape:jobsalert', $params);
    }

    public function failed(\Throwable $exception): void
    {
        Log::error('[ScrapeJobsAlertJobs] queue job failed', [
            'error' => $exception->getMessage(),
        ]);

        Cache::put('scraper_progress_jobsalert', [
            'current' => 0,
            'total' => 0,
            'status' => 'error',
