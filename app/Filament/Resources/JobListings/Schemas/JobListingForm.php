    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                // ── Article Body (AI-generated HTML stored in description_html) ──
                RichEditor::make('description_html')
                    ->label('Article Body (AI Article)')
                    ->helperText('This is the full article HTML generated by AI. Edit directly here.')
                    ->columnSpanFull()
                    ->toolbarButtons([
